...
#     return {"exists": False, "message": "رقم هاتف الولي ."}
...
#             User.otp_expiration > datetime.utcnow()).first()
#         if not user_by_guardian_phone:
#             raise HTTPException(
#                 status_code=404, detail="المستخدم غير موجود أو انتهت صلاحية رمز التحقق")
