...
#     """
#     try:
#         # Query notifications directly instead of using service method
...
#                 logger.error(
#                     f"Error serializing notification {notif.id}: {notif_error}")
#                 continue
...
#             exc_info=True
#         )
#         # Return empty list instead of raising exception to prevent frontend crash
#         return []
