...
Revision ID: 9d7ecfe100b7
Revises: 
Create Date: 2025-11-19 10:36:35.484852
...
def upgrade() -> None:
    ...
    op.create_table('haia_committee',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('county_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['county_id'], ['counties.id'], ondelete='CASCADE'),
    ...
    op.create_index(op.f('ix_haia_committee_id'), 'haia_committee', ['id'], unique=False)
    op.create_table('madaeh_committees',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('county_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['county_id'], ['counties.id'], ondelete='CASCADE'),
    ...
    op.create_index(op.f('ix_madaeh_committees_id'), 'madaeh_committees', ['id'], unique=False)
    op.create_table('clan_rules',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_clan_rules_id'), 'clan_rules', ['id'], unique=False)
    op.create_table('clan_settings',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('clan_id', sa.Integer(), nullable=False),
    sa.Column('allow_cross_clan_reservations', sa.Boolean(), nullable=True),
    ...
    sa.Column('years_max_reserv_GroomFromOutClan', sa.Integer(), nullable=True),
    sa.Column('years_max_reserv_GrooomFromOriginClan', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['clan_id'], ['clans.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('clan_id')
    )
    op.create_index(op.f('ix_clan_settings_id'), 'clan_settings', ['id'], unique=False)
    ...
    sa.Column('menu_details', postgresql.JSON(astext_type=sa.Text()), nullable=False),
    sa.Column('clan_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['clan_id'], ['clans.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_food_menus_id'), 'food_menus', ['id'], unique=False)
    op.create_table('halls_table',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_halls_table_id'), 'halls_table', ['id'], unique=False)
    ...
    sa.Column('status', sa.Enum('validated', 'cancelled', name='reservationspecialstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['clan_id'], ['clans.id'], ),
    sa.ForeignKeyConstraint(['county_id'], ['counties.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_reservations_special_id'), 'reservations_special', ['id'], unique=False)
    op.create_table('users',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('phone_number', sa.String(), nullable=False),
    sa.Column('password_hash', sa.String(), nullable=False),
    sa.Column('role', sa.Enum('super_admin', 'clan_admin', 'groom', name='userrole'), nullable=False),
    ...
    sa.Column('status', sa.Enum('pending_validation', 'validated', 'cancelled', name='reservationstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['clan_id'], ['clans.id'], ),
    sa.ForeignKeyConstraint(['county_id'], ['counties.id'], ),
    sa.ForeignKeyConstraint(['groom_id'], ['users.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['haia_committee_id'], ['haia_committee.id'], ),
    sa.ForeignKeyConstraint(['hall_id'], ['halls_table.id'], ),
    sa.ForeignKeyConstraint(['madaeh_committee_id'], ['madaeh_committees.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('notification_type', sa.Enum('new_reservation', 'reservation_updated', 'reservation_cancelled', 'general_notification', name='notificationtype'), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_reservations_special_id'), table_name='reservations_special')
    ...
    op.drop_index(op.f('ix_madaeh_committees_id'), table_name='madaeh_committees')
